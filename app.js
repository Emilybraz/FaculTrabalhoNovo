...
const items1 = new Item(
    {
        name: "Bem Vindo a lista de a fazeres"
    });

const items2 = new Item(
    {
        name: "Aperte o botao + para adicionar um novo item"
    });

const items3 = new Item(
    {
        name: "<-- Aperte esse botao para remover um item"
    });
        ...
        if (foundItems.length === 0) {
            Item.insertMany(defaultItems, (err) => {
                if (err) {
                    ...
                    console.log("item padroes foram adicionados");
                }
            });
            res.redirect("/");
        } else {
